-- Production testing override for configured ability usage limits.
-- Apply after fix_hivemind_vengeance_workflows.sql.
-- Does not change ability_catalog values or historical ability_casts.
