...
('ability_hivemind', 35, 'Hivemind', 'Plan an event that everyone has to do in the center.', '/assets/abilities/hive_mind_icon.webp', 1, true, 'camp', 1, 'camp', '[{"key":"assigned_camp","label":"Assigned camp","type":"camp","required":true}]', 'ready', '{}', '{"achievement":"veteran_camper"}', '{"CAST_TO_PRODUCTION":"[assigned_camp] is planning an event.","READY_TO_ALL":"[assigned_camp] casts Hivemind. Gather the campers in the center."}'),
...
('ability_vengeance', 25, 'Vengeance', 'The next spell that targets the caster is reflected back.', '/assets/abilities/vengeance_icon.png', null, false, 'user', null, 'user', '[]', 'instant', '{"duration_seconds":3600,"target":"caster","trigger_type":"targeted_ability"}', '{"achievement":"high_score"}', '{"CAST_TO_ALL":"[display_name] has armed [spell_name]. [spell_description]","REFLECTED":"Your spell was reflected by [target_player]."}'),
...
('ability_love_blast', 25, 'Love Blast', 'Make your target serenade the caster.', '/assets/abilities/love_potion_icon.webp', null, false, 'user', null, 'user', '[{"key":"target_player","label":"Target player","type":"player","required":true}]', 'instant', '{}', '{}', '{"CAST_TO_TARGET":"[display_name] hit YOU with [spell_name]. [spell_description]"}'),
('ability_necromancy', 25, 'Necromancy', 'Make your target walk like a zombie through each camp.', '/assets/abilities/necromancy_icon.webp', null, false, 'user', null, 'user', '[{"key":"target_player","label":"Target player","type":"player","required":true}]', 'instant', '{}', '{}', '{"CAST_TO_TARGET":"[display_name] hit YOU with [spell_name]. [spell_description]"}')
