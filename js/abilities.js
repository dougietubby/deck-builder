...
export const ABILITIES = [
  ability('ability_telegrab', 'Telegrab', 'Tell Production to retrieve an item from another camp.', 25, '1 use', 'telegrab_icon.png', [{ key: 'target_player', label: 'Target player', type: 'player', required: true }, { key: 'item', label: 'Item', type: 'item', required: true }], 'commit'),
  ability('ability_hivemind', 'Hivemind', 'Plan an event that everyone has to do in the center.', 35, '1 use per camp', 'hive_mind_icon.png', [{ key: 'assigned_camp', label: 'Assigned camp', type: 'camp', required: true }], 'ready', { usageLimit: 1, usageScope: 'camp', unlockRequirement: { type: 'achievement', id: 'veteran_camper' } }),
  ...
  ability('ability_love_blast', 'Love Blast', 'Make your target serenade the caster.', 25, '1 use', 'love_potion_icon.png', [{ key: 'target_player', label: 'Target player', type: 'player', required: true }]),
  ability('ability_necromancy', 'Necromancy', 'Make your target walk like a zombie through each camp.', 25, '1 use', 'necromancy_icon.png', [{ key: 'target_player', label: 'Target player', type: 'player', required: true }])
];
