...
export const ABILITIES = [
  ...
  ability('ability_vengeance', 'Vengeance', 'The next spell that targets the caster is reflected back.', 25, '1 use', 'vengeance_icon.png', [{ key: 'target_player', label: 'Target player', type: 'player', required: true, exclude_self: true }], 'instant', { durationSeconds: 3600, target: 'target', triggerType: 'targeted_ability', unlockRequirement: { type: 'achievement', id: 'high_score' } }),
